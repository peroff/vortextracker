...
2. Скомпилировать для обеих платформ (Win32 и Win64)
3. Инсталлировать
4. (Не требуется, начиная с VT 2.6.1 dev x64)
   В папке Delphi-Midi-Component найти файлы следующие файлы и скопировать в
   корень проекта VT:
