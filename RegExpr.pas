...
type
  TRegExprModifiers = record
    ...
    R: Boolean;
       ...
       // If True, then à-ÿ additionally includes letter '¸',
       // À-ß additionally includes '¨', and à-ß includes all Russian letters.
...
const
  ...
  {$ELSE}
  RusRangeLoLow = #$E0; // 'à' in cp1251
  RusRangeLoHigh = #$FF; // 'ÿ' in cp1251
  RusRangeHiLow = #$C0; // 'À' in cp1251
  RusRangeHiHigh = #$DF; // 'ß' in cp1251
  {$ENDIF}
